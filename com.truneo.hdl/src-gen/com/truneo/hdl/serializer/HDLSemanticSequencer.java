 ...
 */
package com.truneo.hdl.serializer;
...
public class HDLSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == HDLPackage.eINSTANCE)
			...
			case HDLPackage.DOMAINMODEL:
				sequence_Domainmodel(context, (Domainmodel) semanticObject); 
				return; 
			case HDLPackage.ENTITY:
				sequence_Entity(context, (Entity) semanticObject); 
				return; 
			case HDLPackage.FEATURE:
				sequence_Feature(context, (Feature) semanticObject); 
				return; 
			case HDLPackage.PACKAGE_DECLARATION:
	 ...
	 *
	 * Constraint:
	 *     (name=ID superType=JvmTypeReference? features+=Feature*)
	 */
