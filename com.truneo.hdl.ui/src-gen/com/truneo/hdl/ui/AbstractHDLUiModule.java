...
import com.truneo.hdl.ide.contentassist.antlr.HDLParser;
import com.truneo.hdl.ide.contentassist.antlr.PartialHDLContentAssistParser;
import com.truneo.hdl.ide.contentassist.antlr.internal.InternalHDLLexer;
import com.truneo.hdl.ui.contentassist.HDLProposalProvider;
import com.truneo.hdl.ui.editor.HDLEditor;
import com.truneo.hdl.ui.labeling.HDLDescriptionLabelProvider;
import com.truneo.hdl.ui.labeling.HDLLabelProvider;
import com.truneo.hdl.ui.outline.HDLOutlineTreeProvider;
import com.truneo.hdl.ui.quickfix.HDLQuickfixProvider;
import com.truneo.hdl.validation.HDLValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link HDLUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractHDLUiModule extends DefaultXbaseUiModule {

	public AbstractHDLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(com.truneo.hdl.parser.antlr.internal.InternalHDLLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return HDLParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalHDLLexer.class).toProvider(LexerProvider.create(InternalHDLLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return HDLValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return HDLLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(HDLDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return HDLOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return HDLQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return HDLProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialHDLContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("HDL Compare");
	}
