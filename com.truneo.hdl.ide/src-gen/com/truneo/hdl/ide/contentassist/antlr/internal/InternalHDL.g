...
:
(
	{ before(grammarAccess.getFeatureAccess().getDescAssignment_3()); }
	(rule__Feature__DescAssignment_3)?
	{ after(grammarAccess.getFeatureAccess().getDescAssignment_3()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleJvmTypeReference
		{ after(grammarAccess.getFeatureAccess().getTypeJvmTypeReferenceParserRuleCall_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getFeatureAccess().getDescSTRINGTerminalRuleCall_3_0()); }
		RULE_STRING
		{ after(grammarAccess.getFeatureAccess().getDescSTRINGTerminalRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
